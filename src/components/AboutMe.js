import devThinus from "../assets/couple.jpg";
    ...
    return (
        <section className={"about-me"} id={"about"}>
            ...
            <div className="about-me__body">
                <p>
                    I enjoy building software that looks and feels good. I have a very keen interest in the latest tech
                    stacks and I try to be proficient in as many as possible. I love learning and more often than not, you will find me
                    doing some course or following some YouTube tutorials. I am also busy with my BsC through an online varsity which is keeping
                    me very busy and teaching me a lot of new things.
                </p>
                <br/>
                <p>
            ...
            <img className={"about-me__img"} src={devThinus} alt=""/>
        </section>
    );
}
